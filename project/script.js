...
const WEATHER_API_KEY = 'fed5846f35d53002087ec3e9c8585698'; // Replace with your API key
...
async function getWeather() {
    ...
    try {
        ...
        weatherResult.innerHTML = `
            ...
            <button id="quick-save" style="background-color: #28a745;">Save This Location</button>
        `;
        ...
        weatherResult.innerHTML = `
            <div class="weather-card" style="border-left-color: #dc3545;">
                <h3>Error</h3>
                <p>${error.message}</p>
            </div>
        `;
